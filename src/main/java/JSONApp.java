...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        ...
        JsonObject eng = new JsonObject(new JsonPair("course", new JsonString("English")),
        ...
        JsonArray exms = new JsonArray(oop, eng, math);
        JsonPair exams = new JsonPair("exams",exms);
